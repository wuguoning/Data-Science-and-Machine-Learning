...
if __name__ == "__main__":
    ...
    optimizers["SGD"] = SGD2(lr=0.95)
    optimizers["Momentum"] = Momentum2(lr=0.05)
    optimizers["AdaGrad"] = AdaGrad2(lr=0.95)
    optimizers["Adam"] = Adam2(lr=0.2)
    optimizers["Nesterov"] = Nesterov2(lr=0.05)
    optimizers["RMSprop"] = RMSprop2(lr=0.1)
    optimizers["AdaMax"] = AdaMax2(lr=0.25)
    optimizers["AdaDelta"] = AdaDelta2(lr=11.)
    ...
    for key in optimizers.keys():
        ...
        for i in range(50):
            ...
            [params] = optimizer.update([params], [grads], batch_size=1)
