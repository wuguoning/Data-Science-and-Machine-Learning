...
from neuralsrc.network import Network3
from neuralsrc.network import QuadraticCost3
from neuralsrc.network import CrossEntropyCost3
...
if __name__ == "__main__":
    ...
    # new network
    sizes = [784, 30, 10]
    net = Network3(sizes, cost=CrossEntropyCost3)
    net.large_weight_initializer()

    # save compare results to pandas
    save_file = '../data1/cross_entr_loss_regu_l1_5.csv'
