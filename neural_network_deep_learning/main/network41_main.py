...
from neuralsrc.network import Network4
from neuralsrc.network import QuadraticCost4
from neuralsrc.network import CrossEntropyCost4
...
if __name__ == "__main__":
    ...
    # new network
    sizes = [784, 30, 10]
    net = Network4(sizes, cost=CrossEntropyCost4)
    net.large_weight_initializer()

    # save compare results to pandas
    save_file = '../data1/cross_entr_loss_regu_dropout3.csv'
