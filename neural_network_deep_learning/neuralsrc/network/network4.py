"""network4.py
Network using dropout regularization
...
class CrossEntropyCost4(object):
...
class Network4(object):
    ...
    def __init__(self, sizes, cost=CrossEntropyCost4):
    ...
    def dropout_mask(self, prob=0.3):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            for mini_batch in mini_batches:
                # takes out the weights and biases from self.wights and self.biases as thin_weights and thin_biases
                weights_mask, biases_mask, thin_sizes_num, thin_weights, thin_biases = self.dropout_mask(prob=0.5)

                # update the thin_wights and thin_biases
                thin_weights, thin_biases = self.update_mini_batch(\
                    mini_batch, eta, len(training_data), thin_weights, thin_biases)
    ...
    def update_mini_batch(self, mini_batch, eta, n, thin_weights, thin_biases):
